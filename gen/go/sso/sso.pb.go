...
func (x *IsAdminReponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsAdminReponse) ProtoMessage() {}

func (x *IsAdminReponse) ProtoReflect() protoreflect.Message {
	mi := &file_sso_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsAdminReponse.ProtoReflect.Descriptor instead.
func (*IsAdminReponse) Descriptor() ([]byte, []int) {
	return file_sso_proto_rawDescGZIP(), []int{5}
}

func (x *IsAdminReponse) GetIsAdmin() bool {
	if x != nil {
		return x.IsAdmin
	}
	return false
...
var file_sso_proto_rawDesc = []byte{
	...
	0x0a, 0x0e, 0x49, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x19, 0x0a, 0x08, 0x69, 0x73, 0x5f, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x07, 0x69, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x32, 0xaa, 0x01, 0x0a, 0x04,
	...
	0x65, 0x12, 0x35, 0x0a, 0x07, 0x49, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x12, 0x14, 0x2e, 0x61,
	0x75, 0x74, 0x68, 0x2e, 0x49, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x14, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x49, 0x73, 0x41, 0x64, 0x6d, 0x69,
	0x6e, 0x52, 0x65, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x13, 0x5a, 0x11, 0x2e, 0x2e, 0x2f, 0x2e,
	0x2e, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x67, 0x6f, 0x2f, 0x73, 0x73, 0x6f, 0x2f, 0x62, 0x06, 0x70,
...
var file_sso_proto_goTypes = []any{
	...
	(*IsAdminReponse)(nil),   // 5: auth.IsAdminReponse
}
var file_sso_proto_depIdxs = []int32{
	...
	5, // 5: auth.Auth.IsAdmin:output_type -> auth.IsAdminReponse
